...
import {
  sendAgendaDeadlineReminder, sendUpcomingMeetingReminder,
  AGENDA_REMINDER_DAYS_BEFORE, MEETING_REMINDER_DAYS_BEFORE,
...
export async function GET(request: NextRequest) {
  ...
  return NextResponse.json({
    checked: { agendaMeetings: agendaMeetings?.length ?? 0, upcomingMeetings: upcomingMeetings?.length ?? 0 },
    attempted: { agendaRemindersSent, upcomingRemindersSent },
  })
}
